...
<head>
    <!-- Basic -->
    <title>BLK 1 Singapore | Add Agent </title>
    <!-- Define Charset -->
    <meta charset="utf-8">
...
<body>
    ...
    <div id="content">
      <div class="container">
       ...
       <div class="col-md-8">
                <!-- Classic Heading -->
                <h4 class="classic-title"><span>Add Agent By Admin</span></h4>
                <!-- Start Contact Form -->
                <form role="form" class="contact-form" name="addAgentForm" id="contact-form" method="post" autocomplete="off" onSubmit="return addAgentValidation();">
                     <?php
			if ( isset($errMSG) ) {
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <input type="text" placeholder="Agency" name="agency">
						...
						class="btn-system btn-large" name="agentSignUp">Add</button>
