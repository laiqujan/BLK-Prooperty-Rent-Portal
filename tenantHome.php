...
if(isset($_SESSION['types'])){
    echo "<script language='javascript'>window.location.href='tenancyRequest.php';</script>";
}

$email = $_SESSION['Id'];
$query3 = "select * from tenacyrequest where Email='$email'";
$result3 = $con -> query($query3) or die("Query error");
//$query4 = "select COUNT(RequestId) from tenancyrequest where Email='$email' GROUP BY RequestId";
...
foreach($result3 as $row)
		{			
         $request++;
		 $req = $row['RequestId'];
		 $query4 = "select * from response where RequestId='$req'";
		 $result4 = $con -> query($query4) or die("Query error");
...
if($request == 1){
	header("Location: checkResponse.php?id=$req");
		exit;
}
?>
...
<body>
    ...
    <div id="container">
        ...
        <div class="content">
            ...
            <div class="col-md-4">
			<h1 style="color:silver">Total Response Received</h1>
			<h1><?php echo $respo; ?></h1>
			</div>
            <div class="col-md-4">
			<!-- <h1 style="color:silver">Unresponded Requests</h1>
        ...
        <div class="row">
            <h4 class="classic-title"><span><?php echo $_SESSION["Id"];?>'s Requests</span></h4>
    <?php
	$query = "select * from tenacyrequest where Email='$email'";
  ...
  <tbody>
   <?php 
    ...
    <tr>	
	  ...
	  <td><a href="checkResponse.php?id=<?php echo $row['RequestId']; ?>">Check Response</a></td>
	  <td><a href="removerequest.php?id=<?php echo $row['RequestId']; ?>">Remove</a></td>
    </tr>
	 <?php
	  }
	  ?>
