...
$sql = "select Email,FirstName from agent where Email='$emailid'";
$ctr=0;			
	try
	{
...
else
{
    ...
    $query = "Update agent SET Password='".$newPassword."' where Email='".$emailid."'";			
		try
		{
...
<head>
    <!-- Basic -->
    <title>BLK 1 Singapore | Agent Reset Password</title>
    <!-- Define Charset -->
    <meta charset="utf-8">
    ...
    <div id="content">
      <div class="container">
        <div class="row">
            <div class="col-md-6">
                <!-- Classic Heading -->
                <h4 class="classic-title"><span>Agent Reset Password</span></h4>
                <!-- Start Contact Form -->
