...
<body>
    ...
    <div id="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <ul class="breadcrumbs">
                            <li><a href="#">Home</a></li>
                            <li>Agent - View Tenant Details</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <h4 class="classic-title"><span>Tenant Details</span></h4>
            <?php include("db/opendb.php"); 
    $requestId = $_GET['id'];
    $query = "select Email from tenacyrequest where RequestId='$requestId'";
    $result1= $con -> query($query) or die("Query error");
