...
$user = "agent";
$sql = "select * from agent where Email='$emailid' and Password='$password'";
$ctr=0;			
	try
	{
...
<head>
    <!-- Basic -->
    <title>BLK 1 Singapore | Agent Login</title>
    <!-- Define Charset -->
    <meta charset="utf-8">
                    ...
                    <div class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                ...
                                <ul class="dropdown">
                                    <li>
                                        <a class="active" href="agentLogin.php">Log In</a>
                                    </li>
                                    <li>
    ...
    <div id="content">
      <div class="container">
        <div class="row">
            <div class="col-md-6">
                <!-- Classic Heading -->
                <h4 class="classic-title"><span>Agent Log In</span></h4>
                <!-- Start Contact Form -->
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <input type="password" placeholder="Password" name="password">
                    ...
                    <div class="col-sm-4">
                        <button type="submit" id="submit" class="btn-system btn-large" name="agentLogin">Log In</button>
                        <div id="success" style="color:#34495e;"></div>
                    </div>
                    <div class="col-sm-4">
                            <a href="agentResetPassword.php">Lost your password?</a>
                        </div>
                        <div class="col-sm-4"></div>
                    <div class="col-sm-12">
                        <label> New to site? </label>
                        <a href="agentRegistration.php">Create Account</a>
                    </div>
