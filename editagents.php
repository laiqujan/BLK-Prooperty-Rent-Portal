...
?>
 ...
 <?php 
	...
	$id = $_GET['id'];
	$name = isset($_POST['name']) == TRUE ? trim($_POST['name']) : "";
	$surname = isset($_POST['surname']) == TRUE ? trim($_POST['surname']) : "";
    $email =$id;
	$phoneNumber = isset($_POST['phone']) == TRUE ? trim($_POST['phone']) : "";
	$regNo = isset($_POST['regNo']) == TRUE ? trim($_POST['regNo']) : "";
    $agency = isset($_POST['agency']) == TRUE ? trim($_POST['agency']) : "";
	$pass = isset($_POST['pass']) == TRUE ? trim($_POST['pass']) : "";

	if( isset($_POST['update']))
	{
		if($pass == ""){
			$query = "Update agent SET FirstName='" . $name . "', SurName='" . $surname . "', 
			PhoneNumber='" . $phoneNumber . "',RegistrationNo='" . $regNo . "',
			AgencyName='" . $agency . "' where Email='" . $email . "'";	
			$errTyp = "success";
			...
			$query = "Update agent SET FirstName='" . $name . "', SurName='" . $surname . "', 
			Password='" . $password . "',PhoneNumber='" . $phoneNumber . "',RegistrationNo='" . $regNo . "',
			AgencyName='" . $agency . "' where Email='" . $email . "'";	
			$errTyp = "success";
	...
	{
        $query = "delete from response where Email ='" . $id . "'";
		$con -> query($query) or die("delete error");
		$query = "delete from agent where Email ='" . $id . "'";
		$con -> query($query) or die("delete error");
...
<head>
    <!-- Basic -->
    <title>BLK 1 Singapore | Edit Agents</title>
    <!-- Define Charset -->
    <meta charset="utf-8">
    ...
    <div id="content">
      <div class="container">
        <div class="row">
                      <div class="col-md-8">
                <!-- Classic Heading -->
                <h4 class="classic-title"><span>Agent</span></h4>
                <!-- Start Contact Form -->
                <form role="form" class="contact-form" name="editAgentForm" id="contact-form" method="post" onSubmit="return editAgentValidation();">
                 <?php
			if ( isset($errMSG) ) {
			...
			?>
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <input type="text" placeholder="Sur Name" name="surname"
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <input type="email" class="email" placeholder="E-mail" name="email" value="
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <input type="text" placeholder="registration" name="regNo" 
                ...
                <div class="controls">
				  ...
				  value="<?php echo $agency; ?>" />
						...
						onclick="window.location.href='viewagents.php';">
						Back</button>
                        <div id="success" style="color:#34495e;"></div>
                        </div>
