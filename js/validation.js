...
function agentRegValidation(){
    var name = document.agentRegForm.name;
    var surname = document.agentRegForm.surname;
    var email = document.agentRegForm.email;
    var phone = document.agentRegForm.phone;
    var pass = document.agentRegForm.pass;
    var regNo = document.agentRegForm.regNo;
    var agency = document.agentRegForm.agency;
    var captcha = document.agentRegForm.captcha;
    var recaptcha = document.agentRegForm.recaptcha;
                ...
                {    
                    if(pass_validation(pass))
                    {
                        if(nonempty(regNo))
                        {
                            if(nonempty(agency))
                            {
                                if(captchaVal(captcha,recaptcha))
                                {
                                    return true;
                                }
                            } 
...
function tenantRegValidation(){
    var name = document.tenantRegForm.name;
    var email = document.tenantRegForm.email;
    var phone = document.tenantRegForm.phone;
    var pass = document.tenantRegForm.pass;
    var captcha = document.tenantRegForm.captcha;
    var recaptcha = document.tenantRegForm.recaptcha;
...
function allnumericPhone(phone,max){ 
    ...
    else    
    {
        ...
        phone.value="";
        phone.placeholder="8 digits and numeric characters only";
        return false;
    }
}
