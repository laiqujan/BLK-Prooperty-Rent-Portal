...
<head>
    <!-- Basic -->
    <title>BLK 1 Singapore | Edit Posts</title>
    <!-- Define Charset -->
    <meta charset="utf-8">
            ...
            <div class="navbar navbar-default navbar-top">
                    ...
                    <div class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                ...
                                <ul class="dropdown">
                                    <li>
                                        <a href="viewposts.php">View </a>
                                    </li>
                                    <li>
                                        <a href="editposts.php">Edit</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="viewagents.php">Agents</a>
                            </li>
                            <li>
                                <a href="viewtenants.php">Tenants</a>
                            </li>
                        </ul>
                        <!-- End Navigation List -->
                    </div>
                ...
                <ul class="wpb-mobile-menu">
                    <li>
                            ...
                            <li>
                                <a class="active" href="viewagents.php">Agents</a>
                            </li>
                            <li>
                                <a href="viewtenants.php">Tenants</a>
                            </li>
