...
<head>
    <!-- Basic -->
    <title>BLK 1 Singapore |Responses</title>
    <!-- Define Charset -->
    <meta charset="utf-8">
...
<body>
   ...
   <!-- Content -->
        ...
        <div class="row">
            <!-- Classic Heading -->
                <h4 class="classic-title"><span>Response View Table</span></h4>
  ...
  <tbody>
   <?php 
    ...
    <tr>	
	  ...
	  <td><?php echo $row['PriceNegotiable']; ?></td>
	  <td><a href="deleteresponse.php?id=<?php echo $row['ResponseId']; ?>">Remove</a></td>
    </tr>
	 <?php
	  }
	  ?>
