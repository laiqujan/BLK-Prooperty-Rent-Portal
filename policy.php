...
<head>
    <!-- Basic -->
    <title>BLK 1 Singapore | Privacy Policy</title>
    <!-- Define Charset -->
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="page-content">
          <div class="error-page">
            ...
            <pre>
			This privacy policy discloses the privacy practices for www.blk1sg.com. This privacy policy applies solely to information collected by this web site. It will notify you of the following:
...
Unless you ask us not to, we may contact you via email in the future to notify about updates and other information.
...
Registration 
In order to access certain areas of this website, a user might be required complete the registration form. During registration a user is required to give certain information (such as name and email address). This information is used to contact you about the products/services on our site in which you have expressed interest.
We do not collect and store any sensitive financial information (such as credit card data).
