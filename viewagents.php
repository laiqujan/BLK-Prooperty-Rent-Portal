...
<head>
    <!-- Basic -->
    <title>BLK 1 Singapore | View Agents </title>
    <!-- Define Charset -->
    <meta charset="utf-8">
...
<body>
    ...
    <div id="content">
      <div class="container">
        <div class="row">
                <!-- Classic Heading -->
                <h4 class="classic-title"><span>View Agents</span></h4>
  ...
  <tbody>
   <?php 
    ...
    <tr>
	  ...
	  <td><a href="editagents.php?id=<?php echo $row['Email']; ?>">EDIT</a></td>
	  <td><?php if($row['Status']=="active"){ ?><a href="suspendagent.php?id=<?php echo $row['Email']; ?>">Suspend</a><?php } else{ ?><a href="activeagent.php?id=<?php echo $row['Email']; ?>" class="btn btn-success btn-sx">Active</a> <?php } ?></td>
    </tr>
	 <?php
	  }
	  ?>
