...
Post your requests and check for the responses received by logging to your account at http://www.blk1sg.com/tenantLogin.php 
...
<head>
    <!-- Basic -->
    <title>BLK 1 Singapore | Tenant Registration</title>
    <!-- Define Charset -->
    <meta charset="utf-8">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li>
                                        <a class="active" href="tenantRegistration.php">Sign Up</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li>
                            ...
                            <li>
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li>
                                        <a class="active" href="tenantRegistration.php">
										Sign Up</a>
                                    </li>
                                </ul>
                            </li>
    ...
    <div id="content">
      <div class="container">
        <div class="row">
            <div class="col-md-8">
                <!-- Classic Heading -->
                <h4 class="classic-title"><span>Tenant Sign Up</span></h4>
                <!-- Start Contact Form -->
                <form role="form" name="tenantRegForm" class="contact-form" id="contact-form" method="post" autocomplete="off" onSubmit="return tenantRegValidation();">
                    <?php
			if ( isset($errMSG) ) {
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <input type="text" placeholder="CAPTCHA" name="recaptcha">
                        ...
                        <div class="col-sm-12">
                        <button type="submit" id="submit" class="btn-system btn-large" name="tenantSignUp">Sign Up</button>
                        <div id="success" style="color:#34495e;"></div>
                        </div>
                    <div class="col-sm-12">
                        <label> Already a member? </label>
                        <a href="tenantLogin.php">Log In</a></div>
